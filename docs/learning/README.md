...
| [`git/`](./git/) | Review scopes, safe paths, empty tree, unified diff parsing, execution-environment pinning, services, and errors | [Git service overview](./git/git-service-overview.html) |
